...
| Scrape-Tool | Fetch a webpage and return Markdown. | Darbot Windows MCP</h1>
...
**Option 2:** Use standard Python instead (see "Option B: Using Standard Python" above)
...
Both should show the MCP server information without errors.
